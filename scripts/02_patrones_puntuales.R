...
write.csv(stats_csr, "final/outputs/tabla_04_stats_csr.csv", row.names = FALSE)
...
ggsave("final\\outputs\\figura_03_quadrant_test.tiff", 
       plot = p_quad, 
       width = 10, 
       height = 7, 
       dpi = 300, 
...
# 4.2 Figura 4: Función G con entorno de confianza
...
ggsave("final\\outputs\\figura_04_funcion_g.tiff", 
       plot = p_funcion_g, 
       width = 10, 
       height = 7, 
       dpi = 300, 
...
ggsave("final\\outputs\\figura_05_ripley_kl.tiff", 
       plot = p_ripley, 
       width = 10, 
       height = 7, 
       dpi = 300, 
...
# 4.4 Figura 6: Densidad Kernel (recortada a límites municipales)
...
ggsave("final\\outputs\\figura_06_densidad_kernel.tiff", 
       plot = p_dens, 
       width = 10, 
       height = 7, 
       dpi = 300, 
